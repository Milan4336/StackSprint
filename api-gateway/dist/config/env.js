...
const envSchema = zod_1.z.object({
    ...
    SCORE_RULE_WEIGHT: zod_1.z.coerce.number().default(0.2),
    SCORE_ML_WEIGHT: zod_1.z.coerce.number().default(0.4),
    SCORE_BEHAVIOR_WEIGHT: zod_1.z.coerce.number().default(0.25),
    SCORE_GRAPH_WEIGHT: zod_1.z.coerce.number().default(0.15),
