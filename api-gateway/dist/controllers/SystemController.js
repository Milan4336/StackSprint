...
class SystemController {
    ...
    updates = async (_req, res) => {
        const updatesList = [
            {
                version: 'Patch v3.10',
                date: 'Feb 28, 2026',
                title: 'Settings Routing & Visual Preferences',
                description: 'Restored access to the Settings menu and added a user preference toggle for the high-threat side border glow. Refined the Autonomous Actions "empty state" wording to indicate active monitoring.',
                type: 'feature',
                icon: 'Layout',
                color: 'emerald'
            },
