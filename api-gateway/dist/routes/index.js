...
const AutonomousAgentController_1 = require("../controllers/AutonomousAgentController");
const AdminController_1 = require("../controllers/AdminController");
const UserRepository_1 = require("../repositories/UserRepository");
const FraudAIAgentService_1 = require("../services/FraudAIAgentService");
const RealtimeEventBus_1 = require("../services/RealtimeEventBus");
...
const FraudResponseService_1 = require("../services/FraudResponseService");
...
const UserBehaviorService_1 = require("../services/UserBehaviorService");
const FraudGraphService_1 = require("../services/FraudGraphService");
...
const userBehaviorService = new UserBehaviorService_1.UserBehaviorService(geoService);
const fraudGraphService = new FraudGraphService_1.FraudGraphService();
const otpRepository = new OtpRepository_1.OtpRepository();
const mlServiceClient = new MlServiceClient_1.MlServiceClient();
const modelMetricsService = new ModelMetricsService_1.ModelMetricsService(modelMetricRepository, transactionRepository, mlServiceClient);
...
const fraudScoringService = new FraudScoringService_1.FraudScoringService(ruleEngineService, mlServiceClient, settingsService, userBehaviorService, fraudGraphService);
const fraudResponseService = new FraudResponseService_1.FraudResponseService(fraudAlertRepository, eventBusService, settingsService, auditService);
...
const transactionService = new TransactionService_1.TransactionService(transactionRepository, fraudScoringService, eventBusService, fraudResponseService, // Cast due to name change in constructor pattern
deviceFingerprintService, fraudExplanationService, geoService, auditService, modelMetricsService);
...
const authService = new AuthService_1.AuthService(userRepository, auditService, otpRepository);
const authController = new AuthController_1.AuthController(authService);
const entityController = new EntityController_1.EntityController(transactionRepository, userDeviceRepository, fraudAlertRepository, userRepository);
const adminController = new AdminController_1.AdminController(auditService);
const aiAgentService = new FraudAIAgentService_1.FraudAIAgentService(fraudAlertRepository, caseRepository, new FraudScoringService_1.FraudScoringService(ruleEngineService, mlServiceClient, settingsService, userBehaviorService, new FraudGraphService_1.FraudGraphService()), RealtimeEventBus_1.realtimeEventBus);
aiAgentService.start();
const agentController = new AutonomousAgentController_1.AutonomousAgentController(aiAgentService);
const graphController = new GraphController_1.GraphController();
const dashboard_routes_1 = require("./dashboard.routes");
exports.router = (0, express_1.Router)();
exports.router.use('/api/v1/dashboard', auth_1.authMiddleware, dashboard_routes_1.dashboardRoutes);
exports.router.get('/api/v1/graph', auth_1.authMiddleware, (0, asyncHandler_1.asyncHandler)(graphController.getNetwork));
...
exports.router.post('/api/v1/auth/request-otp', (0, asyncHandler_1.asyncHandler)(authController.requestOtp));
exports.router.post('/api/v1/auth/verify-otp', (0, asyncHandler_1.asyncHandler)(authController.verifyOtp));
exports.router.get('/api/v1/auth/me', auth_1.authMiddleware, (0, asyncHandler_1.asyncHandler)(authController.me));
...
exports.router.get('/api/v1/entities/:id', auth_1.authMiddleware, (0, asyncHandler_1.asyncHandler)(entityController.getEntityById));
exports.router.get('/api/v1/timeline/:id', auth_1.authMiddleware, (0, asyncHandler_1.asyncHandler)(entityController.getTimeline));
exports.router.get('/api/v1/agent/status', auth_1.authMiddleware, (0, asyncHandler_1.asyncHandler)(agentController.getStatus));
exports.router.post('/api/v1/agent/toggle', auth_1.authMiddleware, (0, auth_1.roleMiddleware)(['admin']), (0, asyncHandler_1.asyncHandler)(agentController.toggle));
exports.router.post('/api/v1/admin/unfreeze-user', auth_1.authMiddleware, (0, auth_1.roleMiddleware)(['admin']), (0, asyncHandler_1.asyncHandler)(adminController.unfreezeUser));
exports.router.post('/api/v1/admin/unfreeze-device', auth_1.authMiddleware, (0, auth_1.roleMiddleware)(['admin']), (0, asyncHandler_1.asyncHandler)(adminController.unfreezeDevice));
exports.router.post('/api/v1/admin/release-transaction', auth_1.authMiddleware, (0, auth_1.roleMiddleware)(['admin']), (0, asyncHandler_1.asyncHandler)(adminController.releaseTransaction));
...
exports.router.patch('/api/v1/model/config', auth_1.authMiddleware, (0, auth_1.roleMiddleware)(['admin']), (0, asyncHandler_1.asyncHandler)(modelController.updateConfig));
...
exports.router.get('/api/v1/system/updates', auth_1.authMiddleware, (0, asyncHandler_1.asyncHandler)(systemController.updates));
