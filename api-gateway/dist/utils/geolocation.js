...
exports.haversineKm = exports.geocodeLocation = exports.normalizeLocation = exports.knownLocations = void 0;
exports.knownLocations = {
...
const normalizeLocation = (location) => location.trim().toLowerCase().replace(/\s+/g, '');
exports.normalizeLocation = normalizeLocation;
const geocodeLocation = (location) => {
    const key = (0, exports.normalizeLocation)(location);
    return exports.knownLocations[key] ?? null;
};
